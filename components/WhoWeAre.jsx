...
export default function WhoWeAre() {
  return (
    <Section>
      ...
      <p className="font-inter text-sm font-thin leading-5 mt-2 mr-[100px] mb-5">
        <span className="font-normal">a team of enthusiasts</span> who are fully
      ...
      <p className="font-inter text-sm font-thin leading-5 mr-24 mb-10">
        <span className="font-normal"></span>We believe that nature has the
      ...
      <div>
        ...
        <p className="text-sm text-right mb-10">we have a tour for everyone.</p>
      </div>
      <p className="font-inter text-sm font-thin ">
